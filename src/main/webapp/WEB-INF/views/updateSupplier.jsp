...
<div class="container">
<form method="post" action="<c:url value="/admin/Supplierupdate"/>" class="form-signin">
<span id="reauth-email" class="reauth-email"></span>
<!-- <h4 class="input_title">Category ID</h4>
 --><input class="form-control" type="hidden" name="sid" value="${sat.sid }" required>

<h4 class="input_title">Supplier Name</h4>
<input class="form-control" type="text" name="sname" value="${sat.sname }" required>
